...
from qr_and_number_detection.msg import QrMessage
...
class QRExtractor:
    def __init__(self):
        ...
        self.qr_pub = rospy.Publisher("/qr", QrMessage, queue_size=100)
    ...
    def image_callback(self,data):
        ...
        if len(decodedObjects) == 1:
            ...
            rospy.loginfo("Found 1 QR code in the image!")
            rospy.loginfo(f"Data: {dObject.data.decode('utf-8')}")

            message = QrMessage()
            message.qr_data = dObject.data.decode('utf-8')
            ...
            rospy.logwarn("Found more than 1 QR code")
